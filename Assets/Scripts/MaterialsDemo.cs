...
public class MaterialsDemo : MonoBehaviour {
    ...
    void Start()
    {
        ...
        coloredWalls[15].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[16].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[17].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[18].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[19].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[20].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[21].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[22].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[23].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[24].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[25].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        coloredWalls[26].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)];
        ...
        {
            coloredWalls[15].GetComponent<MeshRenderer>().material = coloredWalls[0].GetComponent<MeshRenderer>().material;
        }
        ...
        {
            coloredWalls[17].GetComponent<MeshRenderer>().material = coloredWalls[2].GetComponent<MeshRenderer>().material;
        }
        ...
        {
            coloredWalls[19].GetComponent<MeshRenderer>().material = coloredWalls[4].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[5].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[20].GetComponent<MeshRenderer>().material = coloredWalls[5].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[6].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[21].GetComponent<MeshRenderer>().material = coloredWalls[6].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[7].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[22].GetComponent<MeshRenderer>().material = coloredWalls[7].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[8].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[23].GetComponent<MeshRenderer>().material = coloredWalls[8].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[9].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[24].GetComponent<MeshRenderer>().material = coloredWalls[9].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[10].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[25].GetComponent<MeshRenderer>().material = coloredWalls[10].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[11].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[26].GetComponent<MeshRenderer>().material = coloredWalls[11].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[12].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[27].GetComponent<MeshRenderer>().material = coloredWalls[12].GetComponent<MeshRenderer>().material;
        }

        if (coloredWalls[13].GetComponent<MeshRenderer>().material = randomMaterials[Random.Range(0, randomMaterials.Length)])
        {
            coloredWalls[28].GetComponent<MeshRenderer>().material = coloredWalls[13].GetComponent<MeshRenderer>().material;
        }
